    ...
    return (
        ...
        <div className="flex-1 flex flex-col justify-center items-center px-12 text-blue-950">
            ...
            <p className="text-lg leading-relaxed mb-4 font-medium text-center">
                Entre com seu email institucional e senha para gerenciar seus empréstimos, consultar o acervo e aproveitar todos os recursos que nossa biblioteca digital oferece.
            </p>
